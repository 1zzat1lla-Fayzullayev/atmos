	...
	return (
		<div className='relative'>
			...
			>
								...
								{[
									...
									>
										...
										<div className='flex flex-col gap-[7px]'>
											<h2 className='text-[17px] md:text-[18px]'>
												{item.title}
											</h2>
											<p className='text-[#C4945E] text-[14px] md:text-[16px]'>
												{item.description}
											</p>
											{item.subDescription && (
				...
				<div className='bg-[#22242A] py-12 pb-[130px]  lg:py-32 w-full lg:w-[65%] flex'>
					<Wrapper>
						...
						<div className='flex w-full justify-center flex-col items-start gap-[40px] mt-[50px]'>
							{[
								...
								>
									...
									/>
									<div className='flex flex-col gap-[7px]'>
										<h3 className='text-[#C4945E] text-[16px] md:text-[20px]'>
											{item.title}
										</h3>
										{item.description && (
					...
					<motion.div
						className='flex items-start justify-start ml-8 mt-[50px] absolute left-0 bottom-[20px] md:bottom-[170px]'
						variants={itemVariants}
					>
			...
			<motion.img
				...
				alt='bottom_icon'
				className='w-full mt-[20px] md:mt-[30px] absolute bottom-0'
				variants={itemVariants}
			/>
		</div>
	)
